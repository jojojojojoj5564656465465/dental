...
const _renderSSR = async (node, opts) => {
  ...
  containerAttributes["q:container"] = "paused", containerAttributes["q:version"] = "1.16.0", containerAttributes["q:render"] = (qRender ? qRender + "-" : "") + "ssr", containerAttributes["q:base"] = opts.base || "", containerAttributes["q:locale"] = locale, containerAttributes["q:manifest-hash"] = opts.manifestHash, containerAttributes["q:instance"] = hash$1();
...
const renderNode = (node, rCtx, ssrCtx, stream, flags, beforeClose) => {
  ...
  if ("string" == typeof tagName) {
    ...
    if (hostCtx) {
      ...
      hostCtx.$flags$ & HOST_FLAG_NEED_ATTACH_LISTENER && (listeners.push(...hostCtx.li), hostCtx.$flags$ &= -3);
    }
...
const processData$1 = (node, rCtx, ssrCtx, stream, flags, beforeClose) => {
  if (null != node && "boolean" != typeof node) {
    if (!isString(node) && "number" != typeof node) {
      ...
      return isPromise(node) ? (stream.write(FLUSH_COMMENT), node.then((node2) => processData$1(node2, rCtx, ssrCtx, stream, flags, beforeClose))) : void 0;
    }
...
const processData = (node, invocationContext) => {
  if (null != node && "boolean" != typeof node) {
    ...
    return isPromise(node) ? node.then((node2) => processData(node2, invocationContext)) : node === SkipRender ? new ProcessedJSXNodeImpl(":skipRender", EMPTY_OBJ, null, EMPTY_ARRAY, 0, null) : void 0;
  }
};
...
const createComputedQrl = (qrl2) => {
  ...
  const task = new Task(TaskFlagsIsDirty | TaskFlagsIsTask | 8, 0, elCtx.$element$, qrl2, signal);
  return qrl2.$resolveLazy$(containerState.$containerEl$), (elCtx.$tasks$ ||= []).push(task), waitAndRun(iCtx, () => runComputed(task, containerState, iCtx.$renderCtx$)), signal;
};
const useComputedQrl = (qrl2) => useConstant(() => createComputedQrl(qrl2));
...
const createElm = (rCtx, vnode, flags, promises) => {
  ...
  const staticCtx = rCtx.$static$;
  const containerState = staticCtx.$containerState$;
  isVirtual ? elm = newVirtualElement(doc, isSvg) : "head" === tag ? (elm = doc.head, flags |= IS_HEAD) : (elm = createElement(doc, tag, isSvg), flags &= -3), 2 & vnode.$flags$ && (flags |= 4), vnode.$elm$ = elm;
  ...
  if (rCtx.$slotCtx$ ? (elCtx.$parentCtx$ = rCtx.$slotCtx$, elCtx.$realParentCtx$ = rCtx.$cmpCtx$) : elCtx.$parentCtx$ = rCtx.$cmpCtx$, isVirtual) {
    ...
    if (isSvg && "foreignObject" === tag && (isSvg = false, flags &= -2), currentComponent) {
      const scopedIds = currentComponent.$scopeIds$;
      scopedIds && scopedIds.forEach((styleId) => {
        elm.classList.add(styleId);
      }), currentComponent.$flags$ & HOST_FLAG_NEED_ATTACH_LISTENER && (elCtx.li.push(...currentComponent.li), currentComponent.$flags$ &= -3);
    }
...
const useStore = (initialState, opts) => {
  ...
  {
    const newStore = getOrCreateProxy(value, iCtx.$renderCtx$.$static$.$containerState$, 1 );
...
const useStylesScopedQrl = (styles) => ({
  scopeId: "⭐️" + _useStyles(styles, getScopedStyles)
});
const _useStyles = (styleQrl, transform, scoped) => {
  ...
  const containerState = iCtx.$renderCtx$.$static$.$containerState$;
  if (set(styleId), elCtx.$appendStyles$ || (elCtx.$appendStyles$ = []), elCtx.$scopeIds$ || (elCtx.$scopeIds$ = []), elCtx.$scopeIds$.push(styleContent(styleId)), containerState.$styleIds$.has(styleId)) {
    return styleId;
  }
...
const renderOpts = __renderOpts;

// @qwik-client-manifest
const manifest = {"manifestHash":"dcwwlv","core":"q-BQjPH2am.js","preloader":"q-DcKcOLyZ.js","qwikLoader":"q-pLIxelCT.js","bundleGraphAsset":"assets/DOtwqYmk-bundle-graph.json","injections":[],"mapping":{"s_I7Bq60YtKSg":"q-CNYi8GNw.js","s_dVRQ869lmlQ":"q-CzpWL1gj.js","s_xUvhUiNfPCI":"q-BBPin9ts.js","s_Aw5B0eG9Jvg":"q-CzpWL1gj.js","s_XsHcshRuD3I":"q-CzpWL1gj.js","s_2ITbRCKrOe4":"q-CzpWL1gj.js","s_CHJ0PGoiLTE":"q-CzpWL1gj.js","s_3fibsKz18AM":"q-DY31jXxh.js","s_F88FFDBKWL4":"q-DY31jXxh.js","s_0yUuAHU2GD4":"q-DvL5Me3c.js","s_YcV0wG7osGE":"q-BCX9W9FA.js","s_ZQ0Aa3K1seI":"q-BCX9W9FA.js","s_u5yiorzCTwg":"q-Bmcsky7m.js","s_26E88I1fHFM":"q-C3bZ88mb.js","s_8aYZfDqg0HY":"q-sVq1hRY7.js","s_Gooq0Fkvy5g":"q-DvL5Me3c.js","s_JzklIbUITXE":"q-CzpWL1gj.js","s_Lf90XTRoo8c":"q-DinenQOD.js","s_N2tvq4ePisI":"q-Bmcsky7m.js","s_OeF40RQCf80":"q-CYrlDWt-.js","s_QoINhQ0SmCw":"q-BCX9W9FA.js","s_VqRREkA7X9s":"q-BBPin9ts.js","s_WDmkJqRoVjU":"q-BQjPH2am.js","s_cJnbkFHhWa8":"q-BCYWIxI3.js","s_isUR60EHt6o":"q-BtgsK78F.js","s_nz7s0N6HIro":"q-Ro1i_HDF.js","s_zE0xgk5g9z4":"q-CNYi8GNw.js","s_qgyn7Z00AoM":"q-BBPin9ts.js","s_zg0IjkWBS08":"q-Ro1i_HDF.js","s_56eU3Ni00nM":"q-D6CZ9532.js","s_9iIBlOa02eI":"q-DY31jXxh.js","s_A8KNs0T9C5c":"q-DY31jXxh.js","s_USx9O1R2csc":"q-SF0ul4KW.js","s_hGBLYqpOAz0":"q-DY31jXxh.js","s_0zbkfZDWW0I":"q-BCX9W9FA.js","s_8pOMQqB3k0w":"q-BBPin9ts.js","s_JXtN8uuliwg":"q-sVq1hRY7.js","s_M0qc9EHj0yI":"q-Ro1i_HDF.js","s_WiQaLMfTEzE":"q-Ro1i_HDF.js","s_YzQQGdwID94":"q-CzpWL1gj.js","s_ZzeLPO6At9Y":"q-CzpWL1gj.js","s_biw20khYPdM":"q-BCX9W9FA.js","s_cm1FhkxOk0o":"q-Ro1i_HDF.js","s_ov9tOAvEfZg":"q-DvL5Me3c.js","s_ua37mqs4ZwE":"q-CNYi8GNw.js"}};
...
async function renderToStaticMarkup(component, props, slotted) {
  ...
  try {
    ...
    const renderToStreamOpts = {
      ...props.renderOpts ?? renderOpts ?? {},
      containerAttributes: {
        style: "display: contents",
        ...false
      },
      qwikLoader: isInitialContainer ? {
        include: "always"
      } : {
        include: "never"
      },
      ...
      ...false,
      serverData: props, manifest: {"version":"1","manifestHash":"dcwwlv","options":{"target":"client","buildMode":"production","entryStrategy":{"type":"smart"}},"core":"q-BQjPH2am.js","preloader":"q-DcKcOLyZ.js","bundleGraphAsset":"assets/DOtwqYmk-bundle-graph.json","injections":[],"mapping":{"s_I7Bq60YtKSg":"q-CNYi8GNw.js","s_dVRQ869lmlQ":"q-CzpWL1gj.js","s_xUvhUiNfPCI":"q-BBPin9ts.js","s_Aw5B0eG9Jvg":"q-CzpWL1gj.js","s_XsHcshRuD3I":"q-CzpWL1gj.js","s_2ITbRCKrOe4":"q-CzpWL1gj.js","s_CHJ0PGoiLTE":"q-CzpWL1gj.js","s_3fibsKz18AM":"q-DY31jXxh.js","s_F88FFDBKWL4":"q-DY31jXxh.js","s_0yUuAHU2GD4":"q-DvL5Me3c.js","s_YcV0wG7osGE":"q-BCX9W9FA.js","s_ZQ0Aa3K1seI":"q-BCX9W9FA.js","s_u5yiorzCTwg":"q-Bmcsky7m.js","s_26E88I1fHFM":"q-C3bZ88mb.js","s_8aYZfDqg0HY":"q-sVq1hRY7.js","s_Gooq0Fkvy5g":"q-DvL5Me3c.js","s_JzklIbUITXE":"q-CzpWL1gj.js","s_Lf90XTRoo8c":"q-DinenQOD.js","s_N2tvq4ePisI":"q-Bmcsky7m.js","s_OeF40RQCf80":"q-CYrlDWt-.js","s_QoINhQ0SmCw":"q-BCX9W9FA.js","s_VqRREkA7X9s":"q-BBPin9ts.js","s_WDmkJqRoVjU":"q-BQjPH2am.js","s_cJnbkFHhWa8":"q-BCYWIxI3.js","s_isUR60EHt6o":"q-BtgsK78F.js","s_nz7s0N6HIro":"q-Ro1i_HDF.js","s_zE0xgk5g9z4":"q-CNYi8GNw.js","s_qgyn7Z00AoM":"q-BBPin9ts.js","s_zg0IjkWBS08":"q-Ro1i_HDF.js","s_56eU3Ni00nM":"q-D6CZ9532.js","s_9iIBlOa02eI":"q-DY31jXxh.js","s_A8KNs0T9C5c":"q-DY31jXxh.js","s_USx9O1R2csc":"q-SF0ul4KW.js","s_hGBLYqpOAz0":"q-DY31jXxh.js","s_0zbkfZDWW0I":"q-BCX9W9FA.js","s_8pOMQqB3k0w":"q-BBPin9ts.js","s_JXtN8uuliwg":"q-sVq1hRY7.js","s_M0qc9EHj0yI":"q-Ro1i_HDF.js","s_WiQaLMfTEzE":"q-Ro1i_HDF.js","s_YzQQGdwID94":"q-CzpWL1gj.js","s_ZzeLPO6At9Y":"q-CzpWL1gj.js","s_biw20khYPdM":"q-BCX9W9FA.js","s_cm1FhkxOk0o":"q-Ro1i_HDF.js","s_ov9tOAvEfZg":"q-DvL5Me3c.js","s_ua37mqs4ZwE":"q-CNYi8GNw.js"},"bundles":{"q-BBPin9ts.js":{"size":2865,"total":485399,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js","q-sVq1hRY7.js"],"origins":["node_modules/@vanilla-extract/dynamic/dist/vanilla-extract-dynamic.cjs.js","node_modules/@vanilla-extract/dynamic/dist/vanilla-extract-dynamic.cjs.prod.js","src/components/HOME/how3/index.tsx_AccordionItem_component_VqRREkA7X9s.js","src/components/HOME/how3/index.tsx_AccordionItem_component_isOpen_useComputed_8pOMQqB3k0w.js","src/components/HOME/how3/index.tsx_AccordionItem_component_li_button_onClick_xUvhUiNfPCI.js","src/components/HOME/how3/index.tsx_AccordionItem_component_useStylesScoped_qgyn7Z00AoM.js","src/components/HOME/how3/main.css?inline"],"symbols":["s_8pOMQqB3k0w","s_qgyn7Z00AoM","s_VqRREkA7X9s","s_xUvhUiNfPCI"],"interactivity":5},"q-BCX9W9FA.js":{"size":4101,"total":126725,"imports":["q-BQjPH2am.js","q-CzpWL1gj.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx_navbar5_component_QoINhQ0SmCw.js","src/components/Layout-Component/navbar5/index.tsx_navbar5_component_closeMobileMenuAndSubmenus_biw20khYPdM.js","src/components/Layout-Component/navbar5/index.tsx_navbar5_component_toggleMobileSubmenu_0zbkfZDWW0I.js","src/components/Layout-Component/navbar5/index.tsx_navbar5_component_useVisibleTask_1_YcV0wG7osGE.js","src/components/Layout-Component/navbar5/index.tsx_navbar5_component_useVisibleTask_ZQ0Aa3K1seI.js"],"symbols":["s_0zbkfZDWW0I","s_biw20khYPdM","s_QoINhQ0SmCw","s_YcV0wG7osGE","s_ZQ0Aa3K1seI"],"interactivity":3},"q-BCYWIxI3.js":{"size":481,"total":59228,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx_ChevronIcon_component_cJnbkFHhWa8.js"],"symbols":["s_cJnbkFHhWa8"],"interactivity":2},"q-Bmcsky7m.js":{"size":2827,"total":61574,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/footer3/index.tsx","src/components/Layout-Component/footer3/index.tsx_footer3_component_N2tvq4ePisI.js","src/components/Layout-Component/footer3/index.tsx_footer3_component_useVisibleTask_u5yiorzCTwg.js"],"symbols":["s_N2tvq4ePisI","s_u5yiorzCTwg"],"interactivity":3},"q-BQjPH2am.js":{"size":51121,"total":54934,"imports":["q-DcKcOLyZ.js"],"origins":["node_modules/@builder.io/qwik/dist/core.min.mjs","node_modules/@qwikdev/astro/src/root.tsx_root_component_WDmkJqRoVjU.js"],"symbols":["s_WDmkJqRoVjU"],"interactivity":2},"q-BRq_RHcz.js":{"size":184,"total":58931,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"dynamicImports":["q-BQjPH2am.js"],"origins":["node_modules/@qwikdev/astro/src/root.tsx"],"interactivity":0},"q-BtgsK78F.js":{"size":1253,"total":240091,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js"],"dynamicImports":["q-DvL5Me3c.js"],"origins":["src/components/HOME/vanityMetrics/card.tsx","src/components/HOME/vanityMetrics/card.tsx_card_component_isUR60EHt6o.js","src/components/HOME/vanityMetrics/data.ts"],"symbols":["s_isUR60EHt6o"],"interactivity":2},"q-C3bZ88mb.js":{"size":242,"total":482776,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js","q-sVq1hRY7.js"],"origins":["src/components/HOME/how3/index.tsx_GenericAccordion_component_26E88I1fHFM.js"],"symbols":["s_26E88I1fHFM"],"interactivity":2},"q-CasaqARS.js":{"size":226,"total":482760,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js","q-sVq1hRY7.js"],"interactivity":0},"q-CNYi8GNw.js":{"size":1738,"total":124362,"imports":["q-BQjPH2am.js","q-CzpWL1gj.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx_MobileSubmenuItem_component_isOpen_useComputed_ua37mqs4ZwE.js","src/components/Layout-Component/navbar5/index.tsx_MobileSubmenuItem_component_li_button_onClick_I7Bq60YtKSg.js","src/components/Layout-Component/navbar5/index.tsx_MobileSubmenuItem_component_zE0xgk5g9z4.js"],"symbols":["s_I7Bq60YtKSg","s_ua37mqs4ZwE","s_zE0xgk5g9z4"],"interactivity":5},"q-CYrlDWt-.js":{"size":121344,"total":180091,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"dynamicImports":["q-Ro1i_HDF.js"],"origins":["node_modules/@emotion/hash/dist/emotion-hash.cjs.js","node_modules/@emotion/hash/dist/emotion-hash.cjs.prod.js","node_modules/@vanilla-extract/css-utils/dist/vanilla-extract-css-utils.esm.js","node_modules/@vanilla-extract/css/adapter/dist/vanilla-extract-css-adapter.browser.cjs.js","node_modules/@vanilla-extract/css/adapter/dist/vanilla-extract-css-adapter.cjs.prod.js","node_modules/@vanilla-extract/css/dist/taggedTemplateLiteral-00b821ff.browser.cjs.js","node_modules/@vanilla-extract/css/dist/taggedTemplateLiteral-0bfb2e96.cjs.prod.js","node_modules/@vanilla-extract/css/dist/transformCss-f152e3c4.browser.cjs.js","node_modules/@vanilla-extract/css/dist/vanilla-extract-css.browser.cjs.js","node_modules/@vanilla-extract/css/fileScope/dist/vanilla-extract-css-fileScope.browser.cjs.js","node_modules/@vanilla-extract/css/fileScope/dist/vanilla-extract-css-fileScope.cjs.js","node_modules/@vanilla-extract/css/fileScope/dist/vanilla-extract-css-fileScope.cjs.prod.js","node_modules/@vanilla-extract/css/functionSerializer/dist/vanilla-extract-css-functionSerializer.cjs.prod.js","node_modules/@vanilla-extract/css/injectStyles/dist/vanilla-extract-css-injectStyles.browser.cjs.js","node_modules/@vanilla-extract/css/recipe/dist/vanilla-extract-css-recipe.cjs.js","node_modules/@vanilla-extract/css/recipe/dist/vanilla-extract-css-recipe.cjs.prod.js","node_modules/@vanilla-extract/private/dist/vanilla-extract-private.esm.js","node_modules/@vanilla-extract/recipes/dist/createRuntimeFn-166334d7.cjs.prod.js","node_modules/@vanilla-extract/recipes/dist/vanilla-extract-recipes.cjs.js","node_modules/@vanilla-extract/recipes/dist/vanilla-extract-recipes.cjs.prod.js","node_modules/@vanilla-extract/sprinkles/createUtils/dist/vanilla-extract-sprinkles-createUtils.cjs.prod.js","node_modules/@vanilla-extract/sprinkles/dist/createSprinkles-410cc880.cjs.prod.js","node_modules/@vanilla-extract/sprinkles/dist/vanilla-extract-sprinkles.cjs.js","node_modules/@vanilla-extract/sprinkles/dist/vanilla-extract-sprinkles.cjs.prod.js","node_modules/css-what/lib/es/index.js","node_modules/css-what/lib/es/parse.js","node_modules/css-what/lib/es/stringify.js","node_modules/css-what/lib/es/types.js","node_modules/cssesc/cssesc.js","node_modules/dedent/dist/dedent.js","node_modules/deep-object-diff/cjs/added.js","node_modules/deep-object-diff/cjs/deleted.js","node_modules/deep-object-diff/cjs/detailed.js","node_modules/deep-object-diff/cjs/diff.js","node_modules/deep-object-diff/cjs/index.js","node_modules/deep-object-diff/cjs/updated.js","node_modules/deep-object-diff/cjs/utils.js","node_modules/deepmerge/dist/cjs.js","node_modules/lru-cache/dist/commonjs/index.js","node_modules/media-query-parser/dist/media-query-parser.esm.js","node_modules/modern-ahocorasick/dist/index.cjs","node_modules/picocolors/picocolors.browser.js","node_modules/valibot/dist/index.js","src/components/HOME/Avis/index.tsx","src/components/HOME/Avis/index.tsx_Avis_component_OeF40RQCf80.js","src/styles/recipe/container.css.ts","src/styles/recipe/containerGrid.css.ts","src/styles/recipe/containerGridMaxColumn.css.ts","src/styles/recipe/flex.css.ts","src/styles/recipe/index.css.ts","src/styles/recipe/spaceMarginPadding.css.ts","src/styles/recipe/textRecipe.css.ts","src/styles/recipe/textSprinkles.css.ts","src/styles/token/fontSize.ts","src/styles/token/index.ts","src/styles/token/media.ts","src/styles/token/space.ts","src/styles/utils/base.css.ts","src/styles/utils/fontFace.css.ts","src/styles/utils/layer.css.ts","src/styles/utils/themeNew.css.ts","src/styles/utils/utils.ts"],"symbols":["s_OeF40RQCf80"],"interactivity":2},"q-CzpWL1gj.js":{"size":5130,"total":63877,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"dynamicImports":["q-BCX9W9FA.js","q-BCYWIxI3.js","q-CNYi8GNw.js","q-D6CZ9532.js","q-DinenQOD.js","q-DY31jXxh.js","q-DY31jXxh.js","q-DY31jXxh.js","q-DY31jXxh.js","q-DY31jXxh.js","q-SF0ul4KW.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_JzklIbUITXE.js","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_isActive_useComputed_ZzeLPO6At9Y.js","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_li_button_onClick_dVRQ869lmlQ.js","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_li_button_onFocus_CHJ0PGoiLTE.js","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_li_div_onMouseEnter_XsHcshRuD3I.js","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_li_div_ul_DentalNavLink_onClick_YzQQGdwID94.js","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_li_onMouseEnter_Aw5B0eG9Jvg.js","src/components/Layout-Component/navbar5/index.tsx_DesktopSubmenuItem_component_li_onMouseLeave_2ITbRCKrOe4.js"],"symbols":["s_2ITbRCKrOe4","s_Aw5B0eG9Jvg","s_CHJ0PGoiLTE","s_dVRQ869lmlQ","s_JzklIbUITXE","s_XsHcshRuD3I","s_YzQQGdwID94","s_ZzeLPO6At9Y"],"interactivity":5},"q-D6CZ9532.js":{"size":411,"total":59158,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx_CloseIcon_56eU3Ni00nM.js"],"symbols":["s_56eU3Ni00nM"],"interactivity":1},"q-D9Z1NZ5J.js":{"size":177,"total":239015,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js"],"interactivity":0},"q-DcKcOLyZ.js":{"size":3813,"total":3813,"origins":["@builder.io/qwik/build","node_modules/@builder.io/qwik/dist/preloader.mjs"],"interactivity":0},"q-DinenQOD.js":{"size":428,"total":59175,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx_DentalNavLink_component_Lf90XTRoo8c.js"],"symbols":["s_Lf90XTRoo8c"],"interactivity":2},"q-DvL5Me3c.js":{"size":1575,"total":240413,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js"],"origins":["src/components/HOME/vanityMetrics/card.tsx_CardEl_component_Gooq0Fkvy5g.js","src/components/HOME/vanityMetrics/card.tsx_CardEl_component_formattedValue_useComputed_ov9tOAvEfZg.js","src/components/HOME/vanityMetrics/card.tsx_CardEl_component_useVisibleTask_0yUuAHU2GD4.js","src/components/HOME/vanityMetrics/vanity.css.ts"],"symbols":["s_0yUuAHU2GD4","s_Gooq0Fkvy5g","s_ov9tOAvEfZg"],"interactivity":3},"q-DY31jXxh.js":{"size":1237,"total":59984,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx_useMobileMenuToggler_checkScreenSize_9iIBlOa02eI.js","src/components/Layout-Component/navbar5/index.tsx_useMobileMenuToggler_toggle_A8KNs0T9C5c.js","src/components/Layout-Component/navbar5/index.tsx_useMobileMenuToggler_useComputed_hGBLYqpOAz0.js","src/components/Layout-Component/navbar5/index.tsx_useMobileMenuToggler_useVisibleTask_1_3fibsKz18AM.js","src/components/Layout-Component/navbar5/index.tsx_useMobileMenuToggler_useVisibleTask_F88FFDBKWL4.js"],"symbols":["s_3fibsKz18AM","s_9iIBlOa02eI","s_A8KNs0T9C5c","s_F88FFDBKWL4","s_hGBLYqpOAz0"],"interactivity":3},"q-pLIxelCT.js":{"size":3117,"total":3117,"origins":["node_modules/@builder.io/qwik/dist/qwikloader.js"],"interactivity":0},"q-Ro1i_HDF.js":{"size":7579,"total":246417,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js"],"origins":["src/components/HOME/Avis/index.tsx_TestimonialSection_component_goToNext_WiQaLMfTEzE.js","src/components/HOME/Avis/index.tsx_TestimonialSection_component_goToPrevious_cm1FhkxOk0o.js","src/components/HOME/Avis/index.tsx_TestimonialSection_component_nz7s0N6HIro.js","src/components/HOME/Avis/index.tsx_TestimonialSection_component_useOn_M0qc9EHj0yI.js","src/components/HOME/Avis/index.tsx_TestimonialSection_component_useStylesScoped_zg0IjkWBS08.js","src/components/HOME/Avis/testimonial-section.css?inline"],"symbols":["s_cm1FhkxOk0o","s_M0qc9EHj0yI","s_nz7s0N6HIro","s_WiQaLMfTEzE","s_zg0IjkWBS08"],"interactivity":2},"q-SF0ul4KW.js":{"size":414,"total":59161,"imports":["q-BQjPH2am.js","q-DcKcOLyZ.js"],"origins":["src/components/Layout-Component/navbar5/index.tsx_MenuIcon_USx9O1R2csc.js"],"symbols":["s_USx9O1R2csc"],"interactivity":1},"q-sVq1hRY7.js":{"size":4858,"total":243696,"imports":["q-BQjPH2am.js","q-CYrlDWt-.js","q-DcKcOLyZ.js"],"dynamicImports":["q-BBPin9ts.js","q-C3bZ88mb.js"],"origins":["src/components/HOME/how3/content.css.ts","src/components/HOME/how3/index.tsx","src/components/HOME/how3/index.tsx_Accordion_component_8aYZfDqg0HY.js","src/components/HOME/how3/index.tsx_Accordion_component_toggleItem_JXtN8uuliwg.js"],"symbols":["s_8aYZfDqg0HY","s_JXtN8uuliwg"],"interactivity":2}},"assets":{"assets/hZMiCATV-icon-testimonial-quote.svg":{"name":"icon-testimonial-quote.svg","size":4786},"assets/DOtwqYmk-bundle-graph.json":{"name":"bundle-graph.json","size":194}},"symbols":{"s_I7Bq60YtKSg":{"displayName":"index.tsx_MobileSubmenuItem_component_li_button_onClick","hash":"I7Bq60YtKSg","ctxKind":"eventHandler","ctxName":"onClick$","captures":true,"canonicalFilename":"index.tsx_MobileSubmenuItem_component_li_button_onClick_I7Bq60YtKSg","parent":"s_zE0xgk5g9z4","origin":"components/Layout-Component/navbar5/index.tsx","loc":[7358,7403]},"s_dVRQ869lmlQ":{"displayName":"index.tsx_DesktopSubmenuItem_component_li_button_onClick","hash":"dVRQ869lmlQ","ctxKind":"eventHandler","ctxName":"onClick$","captures":true,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_li_button_onClick_dVRQ869lmlQ","parent":"s_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[5763,5849]},"s_xUvhUiNfPCI":{"displayName":"index.tsx_AccordionItem_component_li_button_onClick","hash":"xUvhUiNfPCI","ctxKind":"eventHandler","ctxName":"onClick$","captures":true,"canonicalFilename":"index.tsx_AccordionItem_component_li_button_onClick_xUvhUiNfPCI","parent":"s_VqRREkA7X9s","origin":"components/HOME/how3/index.tsx","loc":[2545,2575]},"s_Aw5B0eG9Jvg":{"displayName":"index.tsx_DesktopSubmenuItem_component_li_onMouseEnter","hash":"Aw5B0eG9Jvg","ctxKind":"eventHandler","ctxName":"onMouseEnter$","captures":true,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_li_onMouseEnter_Aw5B0eG9Jvg","parent":"s_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[5343,5403]},"s_XsHcshRuD3I":{"displayName":"index.tsx_DesktopSubmenuItem_component_li_div_onMouseEnter","hash":"XsHcshRuD3I","ctxKind":"eventHandler","ctxName":"onMouseEnter$","captures":true,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_li_div_onMouseEnter_XsHcshRuD3I","parent":"s_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[6359,6423]},"s_2ITbRCKrOe4":{"displayName":"index.tsx_DesktopSubmenuItem_component_li_onMouseLeave","hash":"2ITbRCKrOe4","ctxKind":"eventHandler","ctxName":"onMouseLeave$","captures":true,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_li_onMouseLeave_2ITbRCKrOe4","parent":"s_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[5426,5479]},"s_CHJ0PGoiLTE":{"displayName":"index.tsx_DesktopSubmenuItem_component_li_button_onFocus","hash":"CHJ0PGoiLTE","ctxKind":"eventHandler","ctxName":"onFocus$","captures":true,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_li_button_onFocus_CHJ0PGoiLTE","parent":"s_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[5869,5933]},"s_3fibsKz18AM":{"displayName":"index.tsx_useMobileMenuToggler_useVisibleTask_1","hash":"3fibsKz18AM","ctxKind":"function","ctxName":"useVisibleTask$","captures":true,"canonicalFilename":"index.tsx_useMobileMenuToggler_useVisibleTask_1_3fibsKz18AM","origin":"components/Layout-Component/navbar5/index.tsx","loc":[3659,4131]},"s_F88FFDBKWL4":{"displayName":"index.tsx_useMobileMenuToggler_useVisibleTask","hash":"F88FFDBKWL4","ctxKind":"function","ctxName":"useVisibleTask$","captures":true,"canonicalFilename":"index.tsx_useMobileMenuToggler_useVisibleTask_F88FFDBKWL4","origin":"components/Layout-Component/navbar5/index.tsx","loc":[3335,3397]},"s_0yUuAHU2GD4":{"displayName":"card.tsx_CardEl_component_useVisibleTask","hash":"0yUuAHU2GD4","ctxKind":"function","ctxName":"useVisibleTask$","captures":true,"canonicalFilename":"card.tsx_CardEl_component_useVisibleTask_0yUuAHU2GD4","parent":"s_Gooq0Fkvy5g","origin":"components/HOME/vanityMetrics/card.tsx","loc":[724,1342]},"s_YcV0wG7osGE":{"displayName":"index.tsx_navbar5_component_useVisibleTask_1","hash":"YcV0wG7osGE","ctxKind":"function","ctxName":"useVisibleTask$","captures":true,"canonicalFilename":"index.tsx_navbar5_component_useVisibleTask_1_YcV0wG7osGE","parent":"s_QoINhQ0SmCw","origin":"components/Layout-Component/navbar5/index.tsx","loc":[9180,9459]},"s_ZQ0Aa3K1seI":{"displayName":"index.tsx_navbar5_component_useVisibleTask","hash":"ZQ0Aa3K1seI","ctxKind":"function","ctxName":"useVisibleTask$","captures":true,"canonicalFilename":"index.tsx_navbar5_component_useVisibleTask_ZQ0Aa3K1seI","parent":"s_QoINhQ0SmCw","origin":"components/Layout-Component/navbar5/index.tsx","loc":[8951,9159]},"s_u5yiorzCTwg":{"displayName":"index.tsx_footer3_component_useVisibleTask","hash":"u5yiorzCTwg","ctxKind":"function","ctxName":"useVisibleTask$","captures":true,"canonicalFilename":"index.tsx_footer3_component_useVisibleTask_u5yiorzCTwg","parent":"s_N2tvq4ePisI","origin":"components/Layout-Component/footer3/index.tsx","loc":[974,1034]},"s_26E88I1fHFM":{"displayName":"index.tsx_GenericAccordion_component","hash":"26E88I1fHFM","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_GenericAccordion_component_26E88I1fHFM","origin":"components/HOME/how3/index.tsx","loc":[3367,3519]},"s_8aYZfDqg0HY":{"displayName":"index.tsx_Accordion_component","hash":"8aYZfDqg0HY","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_Accordion_component_8aYZfDqg0HY","origin":"components/HOME/how3/index.tsx","loc":[703,2041]},"s_Gooq0Fkvy5g":{"displayName":"card.tsx_CardEl_component","hash":"Gooq0Fkvy5g","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"card.tsx_CardEl_component_Gooq0Fkvy5g","origin":"components/HOME/vanityMetrics/card.tsx","loc":[361,1772]},"s_JzklIbUITXE":{"displayName":"index.tsx_DesktopSubmenuItem_component","hash":"JzklIbUITXE","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[5049,6783]},"s_Lf90XTRoo8c":{"displayName":"index.tsx_DentalNavLink_component","hash":"Lf90XTRoo8c","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_DentalNavLink_component_Lf90XTRoo8c","origin":"components/Layout-Component/navbar5/index.tsx","loc":[4393,4840]},"s_N2tvq4ePisI":{"displayName":"index.tsx_footer3_component","hash":"N2tvq4ePisI","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_footer3_component_N2tvq4ePisI","origin":"components/Layout-Component/footer3/index.tsx","loc":[901,2978]},"s_OeF40RQCf80":{"displayName":"index.tsx_Avis_component","hash":"OeF40RQCf80","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_Avis_component_OeF40RQCf80","origin":"components/HOME/Avis/index.tsx","loc":[5037,5306]},"s_QoINhQ0SmCw":{"displayName":"index.tsx_navbar5_component","hash":"QoINhQ0SmCw","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_navbar5_component_QoINhQ0SmCw","origin":"components/Layout-Component/navbar5/index.tsx","loc":[8537,13491]},"s_VqRREkA7X9s":{"displayName":"index.tsx_AccordionItem_component","hash":"VqRREkA7X9s","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_AccordionItem_component_VqRREkA7X9s","origin":"components/HOME/how3/index.tsx","loc":[2132,3230]},"s_WDmkJqRoVjU":{"displayName":"root.tsx_root_component","hash":"WDmkJqRoVjU","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"root.tsx_root_component_WDmkJqRoVjU","origin":"../node_modules/@qwikdev/astro/src/root.tsx","loc":[81,136]},"s_cJnbkFHhWa8":{"displayName":"index.tsx_ChevronIcon_component","hash":"cJnbkFHhWa8","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_ChevronIcon_component_cJnbkFHhWa8","origin":"components/Layout-Component/navbar5/index.tsx","loc":[2075,2478]},"s_isUR60EHt6o":{"displayName":"card.tsx_card_component","hash":"isUR60EHt6o","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"card.tsx_card_component_isUR60EHt6o","origin":"components/HOME/vanityMetrics/card.tsx","loc":[1801,2190]},"s_nz7s0N6HIro":{"displayName":"index.tsx_TestimonialSection_component","hash":"nz7s0N6HIro","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_TestimonialSection_component_nz7s0N6HIro","origin":"components/HOME/Avis/index.tsx","loc":[1243,5008]},"s_zE0xgk5g9z4":{"displayName":"index.tsx_MobileSubmenuItem_component","hash":"zE0xgk5g9z4","ctxKind":"function","ctxName":"component$","captures":false,"canonicalFilename":"index.tsx_MobileSubmenuItem_component_zE0xgk5g9z4","origin":"components/Layout-Component/navbar5/index.tsx","loc":[7118,8456]},"s_qgyn7Z00AoM":{"displayName":"index.tsx_AccordionItem_component_useStylesScoped","hash":"qgyn7Z00AoM","ctxKind":"function","ctxName":"useStylesScoped$","captures":false,"canonicalFilename":"index.tsx_AccordionItem_component_useStylesScoped_qgyn7Z00AoM","parent":"s_VqRREkA7X9s","origin":"components/HOME/how3/index.tsx","loc":[2214,2220]},"s_zg0IjkWBS08":{"displayName":"index.tsx_TestimonialSection_component_useStylesScoped","hash":"zg0IjkWBS08","ctxKind":"function","ctxName":"useStylesScoped$","captures":false,"canonicalFilename":"index.tsx_TestimonialSection_component_useStylesScoped_zg0IjkWBS08","parent":"s_nz7s0N6HIro","origin":"components/HOME/Avis/index.tsx","loc":[1270,1276]},"s_56eU3Ni00nM":{"displayName":"index.tsx_CloseIcon","hash":"56eU3Ni00nM","ctxKind":"function","ctxName":"$","captures":false,"canonicalFilename":"index.tsx_CloseIcon_56eU3Ni00nM","origin":"components/Layout-Component/navbar5/index.tsx","loc":[2758,2990]},"s_9iIBlOa02eI":{"displayName":"index.tsx_useMobileMenuToggler_checkScreenSize","hash":"9iIBlOa02eI","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_useMobileMenuToggler_checkScreenSize_9iIBlOa02eI","origin":"components/Layout-Component/navbar5/index.tsx","loc":[3237,3314]},"s_A8KNs0T9C5c":{"displayName":"index.tsx_useMobileMenuToggler_toggle","hash":"A8KNs0T9C5c","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_useMobileMenuToggler_toggle_A8KNs0T9C5c","origin":"components/Layout-Component/navbar5/index.tsx","loc":[3554,3638]},"s_USx9O1R2csc":{"displayName":"index.tsx_MenuIcon","hash":"USx9O1R2csc","ctxKind":"function","ctxName":"$","captures":false,"canonicalFilename":"index.tsx_MenuIcon_USx9O1R2csc","origin":"components/Layout-Component/navbar5/index.tsx","loc":[2500,2735]},"s_hGBLYqpOAz0":{"displayName":"index.tsx_useMobileMenuToggler_useComputed","hash":"hGBLYqpOAz0","ctxKind":"function","ctxName":"useComputed$","captures":true,"canonicalFilename":"index.tsx_useMobileMenuToggler_useComputed_hGBLYqpOAz0","origin":"components/Layout-Component/navbar5/index.tsx","loc":[3414,3491]},"s_0zbkfZDWW0I":{"displayName":"index.tsx_navbar5_component_toggleMobileSubmenu","hash":"0zbkfZDWW0I","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_navbar5_component_toggleMobileSubmenu_0zbkfZDWW0I","parent":"s_QoINhQ0SmCw","origin":"components/Layout-Component/navbar5/index.tsx","loc":[9495,9841]},"s_8pOMQqB3k0w":{"displayName":"index.tsx_AccordionItem_component_isOpen_useComputed","hash":"8pOMQqB3k0w","ctxKind":"function","ctxName":"useComputed$","captures":true,"canonicalFilename":"index.tsx_AccordionItem_component_isOpen_useComputed_8pOMQqB3k0w","parent":"s_VqRREkA7X9s","origin":"components/HOME/how3/index.tsx","loc":[2294,2425]},"s_JXtN8uuliwg":{"displayName":"index.tsx_Accordion_component_toggleItem","hash":"JXtN8uuliwg","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_Accordion_component_toggleItem_JXtN8uuliwg","parent":"s_8aYZfDqg0HY","origin":"components/HOME/how3/index.tsx","loc":[1620,1780]},"s_M0qc9EHj0yI":{"displayName":"index.tsx_TestimonialSection_component_useOn","hash":"M0qc9EHj0yI","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_TestimonialSection_component_useOn_M0qc9EHj0yI","parent":"s_nz7s0N6HIro","origin":"components/HOME/Avis/index.tsx","loc":[1711,2042]},"s_WiQaLMfTEzE":{"displayName":"index.tsx_TestimonialSection_component_goToNext","hash":"WiQaLMfTEzE","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_TestimonialSection_component_goToNext_WiQaLMfTEzE","parent":"s_nz7s0N6HIro","origin":"components/HOME/Avis/index.tsx","loc":[1575,1678]},"s_YzQQGdwID94":{"displayName":"index.tsx_DesktopSubmenuItem_component_li_div_ul_DentalNavLink_onClick","hash":"YzQQGdwID94","ctxKind":"jSXProp","ctxName":"onClick$","captures":true,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_li_div_ul_DentalNavLink_onClick_YzQQGdwID94","parent":"s_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[6641,6710]},"s_ZzeLPO6At9Y":{"displayName":"index.tsx_DesktopSubmenuItem_component_isActive_useComputed","hash":"ZzeLPO6At9Y","ctxKind":"function","ctxName":"useComputed$","captures":true,"canonicalFilename":"index.tsx_DesktopSubmenuItem_component_isActive_useComputed_ZzeLPO6At9Y","parent":"s_JzklIbUITXE","origin":"components/Layout-Component/navbar5/index.tsx","loc":[5207,5251]},"s_biw20khYPdM":{"displayName":"index.tsx_navbar5_component_closeMobileMenuAndSubmenus","hash":"biw20khYPdM","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_navbar5_component_closeMobileMenuAndSubmenus_biw20khYPdM","parent":"s_QoINhQ0SmCw","origin":"components/Layout-Component/navbar5/index.tsx","loc":[9884,9930]},"s_cm1FhkxOk0o":{"displayName":"index.tsx_TestimonialSection_component_goToPrevious","hash":"cm1FhkxOk0o","ctxKind":"function","ctxName":"$","captures":true,"canonicalFilename":"index.tsx_TestimonialSection_component_goToPrevious_cm1FhkxOk0o","parent":"s_nz7s0N6HIro","origin":"components/HOME/Avis/index.tsx","loc":[1473,1551]},"s_ov9tOAvEfZg":{"displayName":"card.tsx_CardEl_component_formattedValue_useComputed","hash":"ov9tOAvEfZg","ctxKind":"function","ctxName":"useComputed$","captures":true,"canonicalFilename":"card.tsx_CardEl_component_formattedValue_useComputed_ov9tOAvEfZg","parent":"s_Gooq0Fkvy5g","origin":"components/HOME/vanityMetrics/card.tsx","loc":[645,703]},"s_ua37mqs4ZwE":{"displayName":"index.tsx_MobileSubmenuItem_component_isOpen_useComputed","hash":"ua37mqs4ZwE","ctxKind":"function","ctxName":"useComputed$","captures":true,"canonicalFilename":"index.tsx_MobileSubmenuItem_component_isOpen_useComputed_ua37mqs4ZwE","parent":"s_zE0xgk5g9z4","origin":"components/Layout-Component/navbar5/index.tsx","loc":[7159,7208]}},"qwikLoader":"q-pLIxelCT.js","platform":{"vite":"","rollup":"4.41.0","env":"node","os":"linux","node":"24.8.0"}},
    ...
    const htmlWithObservers = isClientRouter && htmlWithRerun + `
...
export { Fragment as F, _jsxQ as _, _jsxC as a, _wrapProp as b, componentQrl as c, _IMMUTABLE as d, useComputedQrl as e, useVisibleTaskQrl as f, _noopQrl as g, _fnSignal as h, inlinedQrl as i, useLexicalScope as j, useStylesScopedQrl as k, useOn as l, _wrapSignal as m, createContextId as n, useContextProvider as o, useContext as p, _jsxBranch as q, useStore as r, useOnWindow as s, _renderer0 as t, useSignal as u, renderToStaticMarkup as v };
