import { component$, useSignal, useStore, useVisibleTask$, $, useOnWindow } from '@builder.io/qwik'
...
export default component$(() => {
  ...
  const toggleMobileSubmenu = $((submenuName: string) => {
    mobileSubmenuOpenStates[submenuName] = !mobileSubmenuOpenStates[submenuName]
  })
