...
export const ActiveDesktopSubmenuContext = createContextId<Signal<number>>('desktop-active-submenu-index')
...
export const DesktopSubmenuItem = component$<DesktopSubmenuItemProps>(props => {
...
export const MobileSubmenuItem = component$<MobileSubmenuItemProps>(props => {
  const isOpen = useComputed$(() => props.openStore[props.submenuName] || false)
    ...
    <li class='relative'>
      <button
        ...
        class={[
          ...
          isOpen.value ? 'text-sky-600 bg-sky-50' : 'text-gray-700 hover:text-sky-500 hover:bg-gray-50', // Conditional color
        ]}
...
export default component$(() => {
  ...
  const { isOpen: isMobileMenuOpen, toggle: toggleMobileMenu, isMobileScreen } = useMobileMenuToggler(navBarId)
